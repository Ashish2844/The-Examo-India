                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-md-6 image mt-5 mb-5">
                            <div className="image w-100 h-100 rounded-4">
                                <img src="https://media.gettyimages.com/id/170486052/photo/the-secondary-school-certificate-ssc-dakhil-and-vocational-examinations-started-today-at-10-am.jpg?s=612x612&w=0&k=20&c=krn7c7Hb3N11HvQF4xua9J1VuVW4nbjh6t4Fh9cwxBI=" alt="image" className='w-100 h-100 rounded-4' />
                            </div>
                        </div>
                    </div>
                </div>
